              ...
              <form method="POST" enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="prod_code" id="prod_code" value="<?php echo $alpha; ?>-<?php echo $beta; ?>" class="form-control" required>
                  </div>
                </div>
                <hr>
                <div class="form-row">
                  <div class="col-md-6">
                    ...
                    <div class="file-input-container">
                        <label for="prod_img" class="file-input-label">
                            <span id="file-label-text">Choose product image...</span>
                        </label>
                ...
                <div class="form-row">
                  <div class="col-md-12">
                    ...
                    <textarea rows="5" name="prod_desc" id="prod_desc" class="form-control" required></textarea>
                  </div>
                </div>
                <br>
                <div class="form-row">
  ...
  <script>
    document.getElementById('prod_img').addEventListener('change', function(e) {
        ...
        if (this.files && this.files.length > 0) {
            ...
            document.getElementById('file-label-text').textContent = 'Choose product image...';
