    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link text-light" href="change_profile.php">
              <i class="fas fa-users text-gold"></i> My Profile
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="orders.php">
              <i class="ni ni-cart text-gold"></i> Make Order
            </a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link text-light" href="orders_reports.php">
              <i class="fas fa-shopping-basket text-gold"></i> My Orders
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-light" href="payments_reports.php">
              <i class="fas fa-funnel-dollar text-gold"></i> My Payments
            </a>
          </li>
        </ul>
        <hr class="my-3" style="border-color: rgba(192, 160, 98, 0.2);">
