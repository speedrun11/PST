...
<head>
    ...
    <title>PST - Available Products</title>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <span class="text-muted">Select any product to make an order</span>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th class="text-gold" scope="col">Price</th>
                  ...
                  ?>
                    <tr>
                      <td>
                        <?php
                        if ($prod->prod_img) {
                          echo "<img src='../admin/assets/img/products/$prod->prod_img' height='60' width='60' class='img-thumbnail rounded-circle'>";
                        } else {
                          echo "<img src='../admin/assets/img/products/default.jpg' height='60' width='60' class='img-thumbnail rounded-circle'>";
                        }
                        ?>
                      </td>
                      <td class="text-gold"><?php echo $prod->prod_code; ?></td>
                      <td><?php echo $prod->prod_name; ?></td>
                      <td class="text-gold">₱<?php echo $prod->prod_price; ?></td>
                      <td>
