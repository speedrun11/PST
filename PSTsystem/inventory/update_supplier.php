...
if (!isset($_GET['update'])) {
    $_SESSION['error'] = "No supplier selected for update";
    header("Location: suppliers.php");
    exit;
}

$supplier_id = $_GET['update'];

// Fetch supplier details
$query = "SELECT * FROM rpos_suppliers WHERE supplier_id = ?";
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Update Supplier</h6>
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark" style="background-color: rgba(26, 26, 46, 0.8); border-radius: 20px; padding: 0.5rem 1rem;">
                  ...
                  <li class="breadcrumb-item active text-gold" aria-current="page">Update Supplier</li>
                </ol>
              </nav>
            </div>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <span class="badge badge-primary">ID: <?php echo $supplier_id; ?></span>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control bg-transparent text-white border-light" 
                               placeholder="Enter supplier name" value="<?php echo htmlspecialchars($supplier->supplier_name); ?>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="phone" name="phone" class="form-control bg-transparent text-white border-light" 
                               placeholder="Enter phone number" value="<?php echo htmlspecialchars($supplier->supplier_phone); ?>" required>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label text-white" for="email">Email Address</label>
                        <input type="email" id="email" name="email" class="form-control bg-transparent text-white border-light" 
                               placeholder="Enter email address" value="<?php echo htmlspecialchars($supplier->supplier_email); ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea id="address" name="address" rows="4" class="form-control bg-transparent text-white border-light" 
                                  placeholder="Enter supplier address"><?php echo htmlspecialchars($supplier->supplier_address); ?></textarea>
                      </div>
                    </div>
                  </div>
                  <div class="row">
